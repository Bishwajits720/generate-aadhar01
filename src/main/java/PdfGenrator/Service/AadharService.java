            ...
            try (PDDocument document = new PDDocument()) {
               ...
               //-- PDImageXObject pdImage = PDImageXObject.createFromFileByContent(templateFile, document);
                try (PDPageContentStream contentStream = new PDPageContentStream(document, page, AppendMode.APPEND, true, true)) {
                    ...
                    contentStream.newLineAtOffset(217, 68);
                    ...
                    float xStart1 = 200;
                    float xEnd1 = 460;
                    float y1 = 65; // Adjust this value to position the line below the text
...
//                    contentStream.endText();
                    ...
                    contentStream.newLineAtOffset(177, 515);
                    contentStream.showText(formattedAadharNumber);
                    contentStream.endText();
                 ...
                 // Calculate the line coordinates
                    float xStart = 160;
                    float xEnd = 480;
                    float y = 512; // Adjust this value to position the line below the text
                    ...
                    contentStream.newLineAtOffset(400, 1163); // Adjust the coordinates as needed
